...
// let destinationNamesMoreThan300KmsAwayByTrain = travelDestinations.filter(({ distanceKms, transportations }) => distanceKms > 300 && transportations.includes("train")).map(({ destinationName }) => destinationName)
/*
